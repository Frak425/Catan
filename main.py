...
game_manager.import_dependencies(screen)
graphics_manager.import_dependencies()
input_manager.import_dependencies()
audio_manager.import_dependencies()
player_manager.import_dependencies()
helper_manager.import_dependencies()
animation_manager.import_dependencies()
driver_manager.import_dependencies()
