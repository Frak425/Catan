...
class Toggle:
    def __init__(self, time: int, time_to_flip: float, location: tuple[int, int], height: int, center_width: int, fill_color: tuple[int, int, int], toggle_color: tuple[int, int, int], toggle_gap: int, toggle_name: str, game_manager: GameManager, on: bool = False, guiding_lines: bool = False, callback=None) -> None:
