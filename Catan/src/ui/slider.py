...
class Slider:
    def __init__(self, name: str, wrapper_rect: pygame.Rect, rect: pygame.Rect, min_value: int, max_value: int, initial_value: int, bar_color: tuple[int], slider_color: tuple[int], slider_radius: int) -> None:
        self.name = name
        self.rect = rect
